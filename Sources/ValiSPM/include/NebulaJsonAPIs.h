 ...
 *
 */
NEBULA_JSON_API int Nebula_Json_Obj_Create_From_String(const char *json_str, NebulaJsonObject **json_obj);
 ...
 *
 */
NEBULA_JSON_API int Nebula_Json_Obj_Release(NebulaJsonObject *root_obj);
 ...
 *
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_length(const NebulaJsonObject *json_obj);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Sub_Obj(const NebulaJsonObject *parent_obj, const char *key, const NebulaJsonObject **value_obj);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Type(const NebulaJsonObject *value_obj);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Bool(const NebulaJsonObject *value_obj, int *bool_value);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Double(const NebulaJsonObject *value_obj, double *double_value);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Int(const NebulaJsonObject *value_obj, int *int_value);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_String(const NebulaJsonObject *value_obj, const char **str_value);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Array_length(const NebulaJsonObject *array_obj);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Array_Element(const NebulaJsonObject *array_obj, int index, const NebulaJsonObject **value_obj);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Sub_Obj_Bool(const NebulaJsonObject *obj, const char *key, int *bool_value);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Sub_Obj_Double(const NebulaJsonObject *obj, const char *key, double *double_value);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Sub_Obj_Int(const NebulaJsonObject *obj, const char *key, int *int_value);
 ...
 * 
 */
NEBULA_JSON_API int Nebula_Json_Obj_Get_Sub_Obj_String(const NebulaJsonObject *obj, const char *key, const char **str_value);
